...
frequencies = [15, 150, 220, 300, 500, 650]  # Frequencies of sine waves (Hz), with the last frequency now at 450 Hz
amplitudes = [2.5, 3.5, 1.0, 2.0, 4.0, 2.0]  # Corresponding amplitudes
